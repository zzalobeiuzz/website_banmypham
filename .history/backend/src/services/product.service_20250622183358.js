...
///utils/productUtils
const { calculateDiscountPercent,calculateTimeLeft, formatDiscountProduct } = require("../utils/productUtils");
...
exports.getSaleProducts = async () => {
  ...
  return result.recordset.map(p => {
    ...
    const discountTimeLeft= calculateTimeLeft(discountPercent);
