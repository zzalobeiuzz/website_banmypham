...
exports.getSaleProducts = async () => {
  ...
  return result.// Tính toán phần trăm giảm giá cho mỗi sản phẩm và thêm vào đối tượng trả về
  const productsWithDiscount = recordset.map(p => ({
    ...p, // Sao chép toàn bộ thuộc tính gốc của sản phẩm (ProductName, Price, sale_price, v.v.)
