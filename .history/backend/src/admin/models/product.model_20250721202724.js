  ...
  try {
    ...
    const result = await pool.request()
      ...
      .query(`
          ...
          -- 🔗 Lấy các SubCategory có cùng CategoryID với sản phẩm
...
exports.addProductDB = async (product) => {
  ...
  try {
    ...
    await productRequest
      ...
      .input("SupplierID", sql.NVarChar(100), SupplierID ?? null)
      .input("SubCategoryID", sql.NVarChar(50), DetailID)
      .input("Image", sql.NVarChar(sql.MAX), Image ?? null)
      ...
      .query(`
        INSERT INTO PRODUCT
        (ProductID, ProductName, Price, Type, CategoryID, StockQuantity, SupplierID, IsHot, IsHidden, Image, DetailID, CreatedAt, UpdatedAt)
        VALUES
        (@ProductID, @ProductName, @Price, @Type, @ProdCategoryID, @StockQuantity, @SupplierID, @IsHot, @IsHidden, @Image, @DetailID, @CreatedAt, @UpdatedAt)
      `);
