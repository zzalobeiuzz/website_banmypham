...
const {getAllCategories,getSaleProducts}= require("../services/product.service");

//============================ Gửi danh sách sản phẩm khuyến mãi=============================
exports.getSaleProductsHandler = async (req, res) => {
  try {
    const products = await productSevice.getSaleProducts();
...
exports.getHotProductsHandler  = async (req, res) => {
  try {
    const product = await productSevice.getHotProducts();
