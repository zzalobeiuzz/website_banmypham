...
//===========================Xử lý kiểm tra email gửi mã xác thực để đăng kí=======================
// auth.controller.js
const nodemailer = require("nodemailer");
const verificationCodes = {}; // Bộ nhớ tạm lưu các mã xác thực đã gửi


exports.sendVerificationCoderegister = async (req, res) => {
  ...
  try {
    const result = await checkEmailAndGenerateCode(email,'register');
