...
const sessionMiddleware = session({
  secret:  process.env.DB_USER,,    // 🔑 Khoá bí mật dùng để ký session ID (bắt buộc, nên đặt phức tạp khi production)
  ...
  store: new MSSQLStore({     // 💾 Nơi lưu session (ở đây: SQL Server)
