...
const ProductDetail = () => {
  ...
  const [selectedImageName, setSelectedImageName] = useState("Không tệp ảnh");
            ...
            <div className="product-detail__body">
              <div className="product-detail__image">
                ...
                <div className="upload-wrapper">
                  ...
                  {selectedImageName && <div className="image-name">{selectedImageName}</div>}
                </div>
