        ...
        <>
          ...
          <div className="product-info-group">
            ...
            <div className="product-info-section product-description" id="description">
              <span className="product-info-section__label">Mô tả sản phẩm</span>
              {isEdit ? (
                <ReactQuill
            ...
            <div className="product-info-section product-ingredients" id="ingredients">
              <span className="product-info-section__label">Thành phần</span>
              {isEdit ? (
                <ReactQuill
            ...
            <div className="product-info-section product-usage" id="usage">
              <span className="product-info-section__label">Công dụng</span>
              {isEdit ? (
                <ReactQuill
            ...
            <div className="product-info-section product-instructions" id="instructions">
              <span className="product-info-section__label">Hướng dẫn sử dụng</span>
              {isEdit ? (
                <ReactQuill
