...
const ProductOverviewComponent = () => {
  ...
  const NoScrollWrapper = React.forwardRef((props, ref) => (
    <div
      ...
      style={{
        ...props.style,
        overflowY: "visible", // 🔒 Không scroll trong List
        willChange: "auto",
      }}
    />
  ));
          ...
          <div className="product-right">
            <div className="content">
              <div className="product-data">
                ...
                <div className="data">
                  <List
                    height={filteredProducts.length * 100} // Tăng chiều cao = số item × 100
                    itemCount={filteredProducts.length}
                    itemSize={100}
                    width="100%"
                    outerElementType={NoScrollWrapper} // 👈 Tắt scroll trong List
                  >
