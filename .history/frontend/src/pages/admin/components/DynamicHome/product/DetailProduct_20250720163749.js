...
const ProductDetail = () => {
  ...
  console.log("🖼 product.Image:", ${UPLOAD_BASE}/pictures/product.Image);
  ...
  return (
    <div className="product-detail__wrapper">
      ...
      console.log("🖼 product.Image:", product.Image);
        <img
        src={`${UPLOAD_BASE}/pictures/${product.Image || "default.jpg"}`}
        alt={product.ProductName || "Không có tên"} 
        onError={(e) => { e.target.src = "/images/placeholder.png"; }} // fallback nếu ảnh không tồn tại
      />
      </div>
