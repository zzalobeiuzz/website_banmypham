...
const RegistrationForm = ({ toggleLoginPopup, handleLoginSubmit }) => {
            ...
            <div className="sign-up-social">
              ...
              <div className="social-buttons">
                <button
                  ...
                  onMouseEnter={(e) => (e.currentTarget.querySelector('img').src = './assets/icons/icons8-google-white.png')}
                  onMouseLeave={(e) => (e.currentTarget.querySelector('img').src = './assets/icons/icons8-google-24.png')}
                >
                ...
                <button
                  ...
                  onMouseEnter={(e) => (e.currentTarget.querySelector('img').src = './assets/icons/icons8-facebook-white.png')}
                  onMouseLeave={(e) => (e.currentTarget.querySelector('img').src = './assets/icons/icons8-facebook-24.png')}
                >
              ...
              <span className="return-login">
                Bạn đã có tài khoản?
                <button className="link-style" onClick={handleLoginClick}> Đăng nhập</button>
              </span>
            </div>
          </form>
        )}
