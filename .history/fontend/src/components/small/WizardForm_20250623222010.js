...
const WizardForm = () => {
  ...
  const handleStepClick = (targetStep) => {
    if (targetStep === 1) {
      setStep(1);
    } else if (targetStep === 2 && isStepOneComplete()) {
      setStep(2);
    } else if (targetStep === 3 && isStepOneComplete() && isStepTwoComplete()) {
      setStep(3);
    } else if (targetStep === 4 && isStepOneComplete() && isStepTwoComplete()) {
      setStep(4);
    } else {
      ...
      <div className="step-content">
              ...
              field === "password" ? (
                <div key={field} className="password-input-wrapper">
                  <input
                    ...
                    onChange={(e) => handleChange("account")}
                    required
                  />
                  <span
          ...
          >
            ...
            {["fullName", "phoneNumber", "address"].map((field) => (
              <input
                ...
                onChange={(e) => handleChange("personal")}
        ...
        {step === 4 && (
          ...
          >
            ...
            <p>Chúng tôi đã gửi mã xác thực đến email <strong>{formData.account.email}</strong>.</p>
