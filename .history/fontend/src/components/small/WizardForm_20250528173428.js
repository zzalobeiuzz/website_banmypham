...
const RegistrationForm = () => {
  ...
  const lineStyle = (filled) => ({
    ...
    right: '20px',
    height: '4px',
    backgroundColor: filled ? '#00CFA1' : '#fff',
    zIndex: 0,
    transform: 'translateY(-50%)'
  });

  // Đặt vị trí cho các đường nối
  ...
  return (
    <div style={{ maxWidth: '500px', margin: '50px auto', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={stepsContainerStyle}>
        ...
        {/* Bước 3 */}
        <div
          style={circleStyle(false, step === 3)}
          onClick={() => setStep(3)}
        >
          3
        </div>
...
// Style chung cho input và button
const inputStyle = {
  width: '100%',
  padding: '12px 15px',
  margin: '10px 0',
