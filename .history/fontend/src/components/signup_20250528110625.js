...
const Signup = () => {
  return (
    <div
      className="frame-1"
      style={{
        background: "url('../../public/assets/images/content-image.oU8ikifr.png') center",
      ...
      <div className="frame-2">
        <div className="frame-4">
          ...
          <div className="group-1">
            ...
            <img className="icons-8-tick-1" src="../../public/assets/images/content-image.oU8ikifr.png" alt="tick 1" />
