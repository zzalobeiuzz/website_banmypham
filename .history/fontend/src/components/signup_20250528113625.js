    ...
    <section className="sign-up">
      <div className="container">
        <div className="row justify-content-end me-3">
          <div className="welcome col-12  col-md-9 col-lg-7 col-xl-6 col-xxl-6">
            <div className="text-center mb-4">
              ...
              <h3>Đăng kí ngay để được</h3>
              <ul>
                <li>Tư vấn chuyên sâu miễn phí</li>
                <li>Các ưu đãi mừng đăng kí</li>
                <li>Tham gia các sự kiện khuyến mãi của chúng tôi</li>
              </ul>
            </div>
          </div>
