...
const Header = () => {
 ...
 useEffect(() => {
  ...
  const hysteresis = 5; // khoảng cách an toàn để tránh toggle liên tục
  ...
  const handleScroll = throttle(() => {
    ...
    // Nếu scroll trong khoảng threshold ± hysteresis thì không đổi trạng thái

    console.log({ scrollPosition, isFixed, showCustomService });
  }, 100);
