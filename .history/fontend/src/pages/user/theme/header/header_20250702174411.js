      ...
      <div className={`header ${isFixed ? "fixed-elements" : ""}`}>
                      ...
                      >
                        ...
                        {category.SubCategories &&
                          category.SubCategories.length > 0 && (
                            <div
                              className={`menu-content ${activeCategoryId === category.CategoryID
                                  ? "active"
                                  : ""
                                }`}
                            >
                              <div className="menu-group-top">
                                <a href="https://cocolux.com/danh-muc/trang-diem-makeup-i.83?sort=1">
                                  Nổi bật
                                </a>
                                <a href="https://cocolux.com/danh-muc/trang-diem-makeup-i.83?sort=2">
                                  Bán chạy
                                </a>
                                <a href="https://cocolux.com/danh-muc/trang-diem-makeup-i.83?sort=3">
                                  Hàng mới
                                </a>
                              </div>
                              <div className="menu-group-bottom">
                                {category.SubCategories.map((sub) => (
                                  <a href="/" key={sub.SubCategoryID}>
                                    {sub.SubCategoryName}
                                  </a>
                                ))}
                              </div>
        ...
        <div className="header-bottom">
          <div className="container header-bottom-menu header-menu">
            <div
              className={`menu_item menu_site ${isFixed ? "fixed-elements" : ""
                }`}
            >
              <a href="/" className="item">
                <FontAwesomeIcon icon={faBars} className="fas" />
                      ...
                      category.SubCategories.length > 0 && (
                        ...
                        >
                          ...
                          <div className="menu-group-bottom">
                            ...
                            {category.SubCategories.map((sub) => (<div className="menu-col-item">
                              <a href="/" key={sub.SubCategoryID}>
                                {sub.SubCategoryName}
                              </a></div>
                            ))}
