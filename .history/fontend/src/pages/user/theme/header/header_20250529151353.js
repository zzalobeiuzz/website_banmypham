        ...
        <div className="header-main">
          <div className="container-header-main">
            ...
            <div className="search-bar">
              ...
              <ul className="dropdown-menu bg-black wi">
                <li><a className="dropdown-item" href="#">Tùy chọn A</a></li>
                <li><a className="dropdown-item" href="#">Tùy chọn B</a></li>
                <li><a className="dropdown-item" href="#">Tùy chọn C</a></li>
              </ul>
            </div>
