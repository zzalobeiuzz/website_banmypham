...
const Banner = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {//setInterval là một hàm có sẵn trong JavaScript  thực hiện một 
                                        //đoạn mã (hàm) lặp đi lặp lại sau mỗi khoảng thời gian cố định (tính bằng mili giây).
