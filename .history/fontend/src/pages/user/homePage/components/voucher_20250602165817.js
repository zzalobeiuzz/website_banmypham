...
const vouchers = [
  {
    id: 55,
    title: "Website đơn từ 799K, áp dụng với một số sản phẩm nhất định",
    detail: "GIẢM 75K CHO HOÁ ĐƠN TỪ 799K",
    code: "COCOLUX75K",
    progress: 1.28,
  },
  {
    id: 56,
    title: "Website đơn từ 599K, áp dụng với một số sản phẩm nhất định",
    detail: "GIẢM 55K CHO HOÁ ĐƠN TỪ 599K",
    code: "COCOLUX55K",
    progress: 1,
  },
  {
    id: 57,
    title: "Website đơn từ 499K, áp dụng với một số sản phẩm nhất định",
    detail: "GIẢM 45K CHO HOÁ ĐƠN TỪ 499K",
    code: "COCOLUX45K",
    progress: 1,
  },
  {
    id: 58,
    title: "Website đơn từ 299K, áp dụng với một số sản phẩm nhất định",
    detail: "GIẢM 35K CHO HOÁ ĐƠN TỪ 299K",
    code: "COCOLUX35K",
    progress: 0.98,
  },
];
      ...
      <div className="item-coupon">
        <div className="d-flex align-items-center justify-content-between">
          ...
          <div className="box-coupon box-coupon-right w-100">
            <p className="sub-title-coupon">{voucher.detail}{voucher.title}</p>
            <div className="voucher-detail pb-2"></div>
