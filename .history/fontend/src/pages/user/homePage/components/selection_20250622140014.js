...
const Select = ({ title })   => {
  ...
  const { data: fetchedProducts, loading, error } = useFetchData(
    //Nếu title trả về là "Flash Sale" thì gọi api api/products/sale
        ...
        >
              ...
              >
                  ...
                  <a href="/a" className="product-template">
                    <div className="product-discount"><span className="pe-1">{product.discountPercent}%</span></div>
                    ...
                    <div className="product-progress-sale count-down">{product.discountDate}</div>
                  </a>
                </div>
              ))}
            </div>
