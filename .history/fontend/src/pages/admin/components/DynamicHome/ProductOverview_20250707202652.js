        ...
        <div className="product-wrapper">
            ...
            <div className={`product-content ${filterOpen ? "open" : ""}`}>
                ...
                <div className="product-right">
                    <div className="fw-bold mb-2">Danh sách sản phẩm</div>
                    <div className="container">
                        <div className="product-data">
                            <ul className="field-name">
                                <li class="list-stt">STT</li>
                                <li class="list-id">ID SP</li>
                                <li class="list-name">Tên sản phẩm</li>
                                <li class="list-image">Ảnh</li>
                                <li class="list-price">Giá</li>
                                <li class="list-category">Danh mục</li>
                                <li class="list-stock">Tồn kho</li>
