          ...
          <div className="container">
            <div className="product-data">
              ...
              {products.map((product, index) => (
                <ul key={product.ProductID} className="list-unstyled field-data">
                  <li className="field-col list-stt">{index + 1}</li>
                  <li className="field-col list-id">{product.ProductID}</li>
                  <li className="field-col list-name">{product.ProductName}</li>
                  <li className="field-col list-image">
                    <img src={product.ImageURL} alt={product.ProductName} width="50" />
                  </li>
                  <li className="field-col list-price">{product.Price}</li>
                  <li className="field-col list-category">{product.CategoryName}</li>
                  <li className="field-col list-stock">{product.Stock}</li>
                </ul>
              ))}
            </div>
          </div>
