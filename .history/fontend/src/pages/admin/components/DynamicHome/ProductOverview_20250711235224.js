...
const ProductOverviewComponent = ({ searchKeyword, onAddProduct  }) => {
    ...
    const handleCloseCategories = () => {
        ...
        const lastDelay = (categories.length - 2) * 100; // 0.1s mỗi nút
        const transitionTime = 400; // 0.4s
        const totalTime = lastDelay + transitionTime;
        ...
        <div className="product-wrapper">
            ...
            <div className={`product-content ${filterOpen ? "open" : ""}`}>
                <div className="product-left">
                    ...
                    <button className="btn-add" onClick={onAddProduct}>Thêm SP</button>
