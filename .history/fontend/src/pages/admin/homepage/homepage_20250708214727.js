...
//   // Quản lý trạng thái mở/đóng của các MenuSection
...
//   // Toggle trạng thái của từng section
...
//               isOpen={sectionStates.managementItems}
...
//               isOpen={sectionStates.eventItems}
...
//               isOpen={sectionStates.revenueItems}
...
const MenuSection = ({ title, items, isCollapsed, defaultOpen = true }) => {
  ...
  return (
    <li className={`menu-section ${isOpen ? "open" : ""} ${title.replace(/\s+/g, "-").toLowerCase()}`}>
