        ...
        <button className="content" onClick={() => setIsOpen(!isOpen)}>
          ...
          <img
            src={
                ...
                "./assets/icons/icons-arrow-up.png"
                : "./assets/icons/icons-arrow-down.png"
            }
            alt="arrow toggle"
          />
        </button>

        {/* Luôn render ul và điều khiển animation bằng class show */}
        <ul className={`list-child ${isOpen ? "show" : ""}`}>
          {items.map((item, idx) => (
